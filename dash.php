            ...
            <main class="col-md-9">
                ...
                <div class="container">
                    <div class="dashboard-item">
                        ...
                        <p><?php $username=$_GET['about'];echo $username; ?></p>
                    </div>
                    <div class="dashboard-item">
                        <div id="my-skillset" class="section-title">
                            <h2>Email</h2>
                        </div>
                      <p><?php $email=$_GET['em'];echo $email;?></p>
					...
					<p><?php $class=$_GET['c1'];echo $class;?></p>
					                        <div class="dashboard-item">
                        <div id="assignments" class="section-title">
                            <h2>Task</h2>
                        </div>
			        <p><?php $php=$_GET['ph'];echo $php;?></p>
...
<button class="spring-green-button gradient-button">Database  Module</button>
                    ...
                    <div class="dashboard-item">
                        ...
                        <p>Project is based on php and html.</p>
                    </div>
                </div>
            </main>
        </div>
